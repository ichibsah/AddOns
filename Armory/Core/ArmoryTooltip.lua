--[[
    ...
    Revision: 4c000a61bf2be9c1c2f90d9961796f8905f4ff9f 2016-11-26T18:09:59Z
...
local function RegisterTooltipHook(tooltip, idType, hook, reset)
    ...
    elseif ( not tooltipHooks[tooltip] ) then
        ...
        SetTooltipHook(tooltip, "SetGuildBankItem", _G.GetGuildBankItemLink);
        SetTooltipHook(tooltip, "SetQuestItem", _G.GetQuestItemLink);

        SetTooltipHook(tooltip, "SetRecipeResultItem", C_TradeSkillUI.GetRecipeItemLink);
        SetTooltipHook(tooltip, "SetRecipeReagentItem",C_TradeSkillUI.GetRecipeReagentItemLink) 
