--[[
    ...
    Revision: ba0655bc23d89398cca5e0a6c5350a7f457cfa2f 2017-08-30T13:27:32Z
...
function Armory:GetRelicSlotRankInfo(index, artifact)
    return GetArtifactValue("RelicRankInfo"..index, artifact);
end
