...
local auctionItemClasses = {
    { AUCTION_CATEGORY_WEAPONS, LE_ITEM_CLASS_WEAPON },
    { AUCTION_CATEGORY_ARMOR, LE_ITEM_CLASS_ARMOR },
    { AUCTION_CATEGORY_CONTAINERS, LE_ITEM_CLASS_CONTAINER },
    { AUCTION_CATEGORY_GEMS, LE_ITEM_CLASS_GEM },
    { AUCTION_CATEGORY_ITEM_ENHANCEMENT, LE_ITEM_CLASS_ITEM_ENHANCEMENT },
    { AUCTION_CATEGORY_CONSUMABLES, LE_ITEM_CLASS_CONSUMABLE },
    { AUCTION_CATEGORY_GLYPHS, LE_ITEM_CLASS_GLYPH },
    { AUCTION_CATEGORY_TRADE_GOODS, LE_ITEM_CLASS_TRADEGOODS },
    { AUCTION_CATEGORY_RECIPES, LE_ITEM_CLASS_RECIPE },
    { AUCTION_CATEGORY_BATTLE_PETS, LE_ITEM_CLASS_BATTLEPET },
    { AUCTION_CATEGORY_QUEST_ITEMS, LE_ITEM_CLASS_QUESTITEM },
    { AUCTION_CATEGORY_MISCELLANEOUS, LE_ITEM_CLASS_MISCELLANEOUS }
}
...
function ArmoryItemFilter(link)
    if ( ArmoryItemFilter_IsEnabled() ) then
        local _, _, itemRarity, _, _, _, _, _, _, _, _, itemType = GetItemInfo(link);
