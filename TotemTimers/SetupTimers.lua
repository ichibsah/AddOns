...
local Cooldowns = {
    [EARTH_TOTEM_SLOT] = {
		...
		[3] = SpellIDs.EarthGrab,
        [4] = SpellIDs.StoneBulwark,
        [5] = SpellIDs.Tremor,
        [6] = SpellIDs.EarthElemental,
    },
    [WATER_TOTEM_SLOT] = {
    ...
    [FIRE_TOTEM_SLOT] = {
        [2] = SpellIDs.FireElemental,
    },
    [AIR_TOTEM_SLOT] = {
        [2] = SpellIDs.Grounding,
        [3] = SpellIDs.SpiritLink,
        [4] = SpellIDs.WindWalk,
...
function TotemTimers.CreateCastButtons()
    for i = 1,4 do 
        TTActionBars:new(5, XiTimers.timers[i].button, _G["TotemTimers_CastBar"..i], TotemTimersFrame)
        for j = 1,5 do
