...
function ArmoryGuildBankFrame_Register()
    ...
    Armory.options["ARMORY_CMD_SET_AGBCOUNTPGB"] = {
        type = "toggle",
        set = function(value) AGB:SetConfigPersonalGuildItemCount(value and value ~= "0"); end,
        get = function() return AGB:GetConfigPersonalGuildItemCount(); end,
        default = false
    };
...
function AGB:SetConfigPersonalGuildItemCount(on)
    Armory:Setting("General", "AgbPersonalGuildItemCount", on);
end

function AGB:GetConfigPersonalGuildItemCount()
    return Armory:Setting("General", "AgbPersonalGuildItemCount");
end
...
function AGB:SetConfigItemCountNumberColor(r, g, b)
    Armory:Setting("General", "AgbItemCountNumberColor", r, g, b);
end

function AGB:GetConfigItemCountNumberColor(default)
    local r, g, b = Armory:Setting("General", "AgbItemCountNumberColor");
    if ( default or not r ) then
