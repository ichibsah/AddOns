...
L["CONFIG_CLICK_CANCEL"] = "Shift+clique no leilão seu para cancela-lo."
L["CONFIG_CLICK_CANCEL_TOOLTIP_HEADER"] = "Clique Para Cancelar"
L["CONFIG_CLICK_CANCEL_TOOLTIP_TEXT"] = "Quando ativado, clicar em um leilão seu na lista de leilões da aba de Venda vai cancela-lo."
...
L["SPLASH_833_SELLING_IMPROVEMENTS_3"] = "O nível dos bixos de estimação agora é exibido na coluna de \"Nícel do Item\""
